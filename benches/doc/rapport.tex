...
\pgfkeyssetvalue{/vector/aarch64}{AArch64}
...
\pgfkeyssetvalue{/vector/nsimd-aarch64}{NSIMD -- AArch64}
...
\foreach \ext in {sse2,sse42,avx,avx2,avx512-skylake,aarch64}{
  \IfFileExists{../results/nsimd-\ext-perf.out}{%
    ...
    \lstinputlisting{../results/\ext-perf.out}

    \subsubsection{NSIMD for \prettyext{} Performance Report}
    \lstinputlisting{../results/nsimd-\ext-perf.out}
