...
elseif ("${GMX_NSIMD_FOR}" STREQUAL "SSE42")
...
elseif ("${GMX_NSIMD_FOR}" STREQUAL "AVX512_SKYLAKE")
  set(GMX_SUGGESTED_SIMD "AVX_512")
elseif ("${GMX_NSIMD_FOR}" STREQUAL "AVX512_KNL")
  set(GMX_SUGGESTED_SIMD "AVX_512_KNL")
elseif ("${GMX_NSIMD_FOR}" STREQUAL "AARCH64")
  set(GMX_SUGGESTED_SIMD "ARM_NEON_ASIMD")
elseif ("${GMX_NSIMD_FOR}" STREQUAL "NEON128")
  set(GMX_SUGGESTED_SIMD "ARM_NEON")
elseif ("${GMX_NSIMD_FOR}" STREQUAL "SVE")
  set(GMX_SUGGESTED_SIMD "ARM_SVE")
elseif ("${GMX_NSIMD_FOR}" STREQUAL "SVE512")
  set(GMX_SUGGESTED_SIMD "ARM_SVE512")
else()
...
if ((${GMX_SUGGESTED_SIMD} STREQUAL "AVX2_256") OR (${GMX_SUGGESTED_SIMD} STREQUAL "AVX2_128"))
  set(NSIMD_COMPILE_FLAGS "-DAVX2 -mavx2 -DFMA -mfma")
...
elseif (${GMX_SUGGESTED_SIMD} STREQUAL "AVX_128_FMA")
  set(NSIMD_COMPILE_FLAGS "-DAVX -mavx -DFMA -mfma")
  set(NSIMD_LINKER_FLAGS "-L${GMX_NSIMD_LIBRARY_PATH} -lnsimd_x86_64")

elseif (${GMX_SUGGESTED_SIMD} STREQUAL "AVX_256")
  set(NSIMD_COMPILE_FLAGS "-DAVX -mavx")
  set(NSIMD_LINKER_FLAGS "-L${GMX_NSIMD_LIBRARY_PATH} -lnsimd_x86_64")

elseif(${GMX_SUGGESTED_SIMD} STREQUAL "AVX_512_KNL")
  set(NSIMD_COMPILE_FLAGS "-DAVX512_KNL -mavx512_knl -DFMA -mfma")
  set(NSIMD_LINKER_FLAGS "-L${GMX_NSIMD_LIBRARY_PATH} -lnsimd_x86_64")

elseif(${GMX_SUGGESTED_SIMD} STREQUAL "AVX_512")
  set(NSIMD_COMPILE_FLAGS "-DAVX512_SKYLAKE -mavx512f -mavx512dq -mavx512cd -mavx512bw -mavx512vl -DFMA -mfma")
  set(NSIMD_LINKER_FLAGS "-L${GMX_NSIMD_LIBRARY_PATH} -lnsimd_x86_64")
...
elseif(${GMX_SUGGESTED_SIMD} STREQUAL "ARM_SVE")
  set(NSIMD_COMPILE_FLAGS "-DSVE -march=armv8-a+sve")
  set(NSIMD_LINKER_FLAGS "-L${GMX_NSIMD_LIBRARY_PATH} -lnsimd_aarch64")

elseif(${GMX_SUGGESTED_SIMD} STREQUAL "ARM_SVE512")
  set(NSIMD_COMPILE_FLAGS "-DSVE512 -march=armv8-a+sve -msve-vector-bits=512")
  set(NSIMD_LINKER_FLAGS "-L${GMX_NSIMD_LIBRARY_PATH} -lnsimd_aarch64_sve512")
