...
#include "impl_nsimd_avx_256_simd_float.h"
...
class SimdDInt32
{
    public:
        ...
        // Internal utility constructor to simplify return statement
        SimdDInt32(__m128i /*Invalid register*/ simd) : simdInternal_(simd) {}

        __m128i /*Invalid register*/ simdInternal_;
};
...
class SimdDIBool
{
    public:
        ...
        // Internal utility constructor to simplify return statement
        SimdDIBool(__m128i /*Invalid register*/ simd) : simdInternal_(simd) {}
...
{
    return {
               nsimd::cvt<nsimd::pack<double> >(nsimd::rec11(nsimd::cvt<nsimd::pack<float> >(x.simdInternal_)))
    };
}
...
#endif
    return {
               nsimd::cvt<nsimd::pack<double> >(nsimd::rsqrt11(nsimd::cvt<nsimd::pack<float> >(x.simdInternal_))) & m.simdInternal_
    };
}
...
#endif
    return {
               nsimd::cvt<nsimd::pack<double> >(nsimd::rec11(nsimd::cvt<nsimd::pack<float> >(x.simdInternal_))) & m.simdInternal_
    };
}
...
{
    return {
               nsimd::andnotb(nsimd::set1<nsimd::pack<double> >(-0.), x.simdInternal_)
    };
}
...
frexp(SimdDouble value, SimdDInt32 * exponent)
{
    ...
    const __m128i /*Invalid register*/ exponentBias = nsimd::set1<nsimd::pack<int> >(1022); // add 1 to make our definition identical to frexp(
    ...
    iExponentLow = nsimd::cvt<__m128i /*Invalid register*/ >(nsimd::cvt<nsimd::pack<long> >(iExponentLow) >> nsimd::cvt<nsimd::pack<long> >(52));
    iExponentHigh = nsimd::cvt<__m128i /*Invalid register*/ >(nsimd::cvt<nsimd::pack<long> >(iExponentHigh) >> nsimd::cvt<nsimd::pack<long> >(52));
    ...
    iExponentLow = iExponentLow | iExponentHigh;
    simdInternal_ = nsimd::cvt<__m128i /*Invalid register*/ >(nsimd::cvt<nsimd::pack<int> >(iExponentLow) - nsimd::cvt<nsimd::pack<int> >(exponentBias));
...
ldexp(SimdDouble value, SimdDInt32 exponent)
{
    ...
    __m128i /*Invalid register*/ iExponentLow, iExponentHigh;
    nsimd::pack<double> fExponent;

    iExponentLow = nsimd::cvt<__m128i /*Invalid register*/ >(nsimd::cvt<nsimd::pack<int> >(exponent.simdInternal_) + nsimd::cvt<nsimd::pack<int> >(exponentBias));
    ...
    iExponentHigh = nsimd::cvt<__m128i /*Invalid register*/ >(nsimd::cvt<nsimd::pack<long> >(iExponentHigh) << nsimd::cvt<nsimd::pack<long> >(52));
    iExponentLow = nsimd::cvt<__m128i /*Invalid register*/ >(nsimd::cvt<nsimd::pack<long> >(iExponentLow) << nsimd::cvt<nsimd::pack<long> >(52));
    fExponent = nsimd::reinterpret<nsimd::pack<double> >(__builtin_ia32_vinsertf128_si256((__v8si)(__m256i)(_mm256_castsi128_si256(iExponentLow)), (__v4si)(__m128i)(iExponentHigh), (int)(1)));
    return {
               value.simdInternal_ * fExponent
    };
}
...
{
    return {
               nsimd::eq(nsimd::cvt<nsimd::pack<int> >(a.simdInternal_), nsimd::cvt<nsimd::pack<int> >(b.simdInternal_))
    };
}
...
{
    return {
               nsimd::lt(nsimd::cvt<nsimd::pack<int> >(a.simdInternal_), nsimd::cvt<nsimd::pack<int> >(b.simdInternal_))
    };
}
...
testBits(SimdDInt32 a)
{
    ...
    __m128i /*Invalid register*/ res = nsimd::andnotb(nsimd::eq(nsimd::cvt<nsimd::pack<int> >(x), nsimd::set1<nsimd::pack<int> >(0)), nsimd::eq(nsimd::cvt<nsimd::pack<int> >(x), nsimd::cvt<nsimd::pack<int> >(x)));
...
{
    __m128d /*Invalid register*/ lo = nsimd::reinterpret<__m128d >(_mm_unpacklo_epi32(a.simdInternal_, a.simdInternal_));
...
#endif // GMX_SIMD_IMPL_X86_AVX_256_SIMD_DOUBLE_
