...
public:
  ...
  SimdDouble(nsimd::pack<double> v) : simdInternal_(v) {}
...
public:
  ...
  // Internal utility constructor to simplify return statements
  SimdDBool(nsimd::packl<double> v) : simdInternal_(v) {}
...
static inline SimdDouble gmx_simdcall operator-(SimdDouble x) {
  return {x.simdInternal_ ^ nsimd::set1<nsimd::pack<double> >(-0.)};
}
...
static inline SimdDouble gmx_simdcall maskzMul(SimdDouble a, SimdDouble b,
                                               SimdDBool m) {
  return {(a.simdInternal_ * b.simdInternal_) &
          nsimd::to_mask(m.simdInternal_)};
}

static inline SimdDouble maskzFma(SimdDouble a, SimdDouble b, SimdDouble c,
                                  SimdDBool m) {
...
static inline SimdDouble gmx_simdcall selectByMask(SimdDouble a,
                                                   SimdDBool mask) {
  return {a.simdInternal_ & nsimd::to_mask(mask.simdInternal_)};
}

static inline SimdDouble gmx_simdcall selectByNotMask(SimdDouble a,
                                                      SimdDBool mask) {
  return {nsimd::andnotb(a.simdInternal_, nsimd::to_mask(mask.simdInternal_))};
}

//#endif

// static inline bool gmx_simdcall
// anyTrue(SimdDIBool a) { return nsimd::any(nsimd::loadla<nsimd::packl<int>
// >(a.simdInternal_)); }

static inline SimdDouble gmx_simdcall fma(SimdDouble a, SimdDouble b,
                                          SimdDouble c) {
  return {nsimd::fma(a.simdInternal_, b.simdInternal_, c.simdInternal_)};
}

static inline SimdDouble gmx_simdcall fms(SimdDouble a, SimdDouble b,
                                          SimdDouble c) {
  return {nsimd::fms(a.simdInternal_, b.simdInternal_, c.simdInternal_)};
}

static inline SimdDouble gmx_simdcall fnma(SimdDouble a, SimdDouble b,
                                           SimdDouble c) {
  return {nsimd::fnma(a.simdInternal_, b.simdInternal_, c.simdInternal_)};
}

static inline SimdDouble gmx_simdcall fnms(SimdDouble a, SimdDouble b,
                                           SimdDouble c) {
