...
#include "impl_nsimd_avx_256_simd_double.h"
...
{
    nsimd::pack<double> t1 = _mm256_unpacklo_pd(*v0, *v1);
    nsimd::pack<double> t2 = _mm256_unpackhi_pd(*v0, *v1);
    nsimd::pack<double> t3 = _mm256_unpacklo_pd(*v2, *v3);
                       ...
                       SimdDouble          v2)
{
    ...
    t0 = _mm256_unpacklo_pd(v0.simdInternal_, v1.simdInternal_); // x0 y0 | x2 y
...
#endif // GMX_SIMD_IMPL_X86_AVX_256_UTIL_DOUBLE_
