...
static inline void gmx_simdcall gatherLoadTranspose(
  ...
  v0->simdInternal_ =
      _mm256_insertf128_ps(_mm256_castps128_ps256(t1), t5, 0x1);
  v1->simdInternal_ =
      _mm256_insertf128_ps(_mm256_castps128_ps256(t2), t6, 0x1);
  v2->simdInternal_ =
      _mm256_insertf128_ps(_mm256_castps128_ps256(t3), t7, 0x1);
  v3->simdInternal_ =
      _mm256_insertf128_ps(_mm256_castps128_ps256(t4), t8, 0x1);
...
transposeScatterStoreU(float *base, const std::int32_t offset[], SimdFloat v0,
  ...
  _mm_maskstore_ps(base + align * offset[0], mask,
                   _mm256_castps256_ps128(v0.simdInternal_));
  _mm_maskstore_ps(base + align * offset[1], mask,
                   _mm256_castps256_ps128(v1.simdInternal_));
  _mm_maskstore_ps(base + align * offset[2], mask,
                   _mm256_castps256_ps128(v2.simdInternal_));
  _mm_maskstore_ps(base + align * offset[3], mask,
                   _mm256_castps256_ps128(tv3));
  _mm_maskstore_ps(base + align * offset[4], mask,
                   _mm256_extractf128_ps(v0.simdInternal_, 0x1));
  _mm_maskstore_ps(base + align * offset[5], mask,
                   _mm256_extractf128_ps(v1.simdInternal_, 0x1));
  _mm_maskstore_ps(base + align * offset[6], mask,
                   _mm256_extractf128_ps(v2.simdInternal_, 0x1));
